...
from riskmodel.NNUtil import *
from riskmodel.Base import Base
...
if __name__ == '__main__':
    from riskmodel.Util import DataUtil
    ...
    for generator in (DataUtil.gen_xor, DataUtil.gen_spiral, DataUtil.gen_nine_grid):
        ...
        nn = Basic(model_param_settings={"n_epoch": 200}).scatter2d(x_train, y_train).fit(
            x_train, y_train, x_test, y_test, snapshot_ratio=0,verbose=3
